...
<body <?php if($page['direction']) echo 'dir="rtl"' ?> >
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background: linear-gradient(45deg,rgba(0, 4, 40, 0.9),rgba(0, 78, 146, 0.9));"><?php if(x($page,'nav')) echo $page['nav']; ?></nav>
	<main>
